package org.principles.ocp.example3;
...
//	
//
//	public AndSpecification(List<T> specification) {
//		super();
...
//		return specification.stream().filter(p -> p.i)
...
class OCPDemo {
	public static void main(String[] args) {
		...
		Product wmelon = new Product("WaterMelon", Color.GREEN, Size.LARGE);
